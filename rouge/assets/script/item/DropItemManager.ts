import { _decorator, Component, Node, Camera, Vec2, v2, Vec3, Prefab, find, Collider2D, Contact2DType, IPhysics2DContact, RigidBody2D, CircleCollider2D, v3, macro } from 'cc';
